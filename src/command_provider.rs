...
pub fn CommandPositioner(
    ...
    let h_ref = provide_hotkeys_context(false, scopes!());
    ...
    view! {
        ...
        class="leptos-kbar">
            <Show when=move || show_kbar.get()>
                ...
                >
                    <Command show_kbar=show_kbar show_theme=show_theme themekey=themekey/>
                </div>
            </Show>
        </div>
    }
...
#[component]
pub fn CommandMenu(
    #[prop(default = "meta+k")] hotkey: &'static str,
