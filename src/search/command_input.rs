use crate::command::{CONTENT_HEADER_CSS, CONTENT_ITEM_CSS};
use crate::command_provider::{use_kbar_context, KBarContext};
...
#[component]
pub fn CommandGroup(search_input: ReadSignal<String>) -> impl IntoView {
        ...
        <ul>
            ...
            <For
                ...
                children=move |(idx, action_ref)| {
                    view! { <CommandItem curr_index=curr_index index=idx action=action_ref.clone()/> }
                }
            />
