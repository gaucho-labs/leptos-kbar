use crate::search::command_input::{CommandInput, CommandGroup};
use leptos::*;
...
pub fn Command(
    ...
    view! {
        ...
        >
            <CommandInput search_input=search_input set_search_input=set_search_input/>
            <CommandGroup search_input=search_input/>
